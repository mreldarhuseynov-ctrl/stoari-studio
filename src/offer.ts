...
export const OFFER: Record<Lang, Offer> = {
  en: {
    ...
    funnel: {
      eyebrow: '06 — LEADS & AUTOMATION',
      title: ['The film brings them in.', 'This is what catches them.'],
      lede: 'The film does its work, the buyer writes on WhatsApp — and waits four hours because the agent is out at a viewing. Every studio on this coast stops at the film. We build what comes after it: the page, the bot that answers in three languages, the CRM the enquiry lands in. Apps for a development are quoted on their own.',
      groups: [
        {
          title: 'Built once, then kept running',
          packs: [
            {
              n: '01',
              t: 'Property funnel',
              ...
              note: 'WITH A SHOOT',
              rows: [
                'A page for the property, on its own domain',
                'A WhatsApp bot that answers at once, in three languages',
                'Every enquiry lands in the CRM with the source it came from',
                'Follow-up goes out while the buyer is still warm',
              ],
              foot: 'Plus from €190 a month — hosting, domain and the bot kept running. With the visualisation and the shoot day, the whole launch is from €6,900.',
            },
            {
              n: '02',
              t: 'Agency bot',
              ...
              price: 'from €1,900',
              rows: [
                'Answers in English, Spanish and Russian',
                'Asks what they are looking for and what they can spend',
                'Books the viewing straight into the calendar',
                'Hands the agent an enquiry someone has already talked to',
              ],
              foot: 'Plus from €290 a month.',
            },
            {
              n: '03',
              t: 'Property CRM',
              ...
              price: 'from €4,500',
              rows: [
                'Built around how an agency here actually works',
                'Properties, buyers, agents, tasks',
                'Whose enquiry it is and what was promised on it',
                'Access rights for each agent',
                'The data stays yours, on your own domain',
              ],
              foot: 'Plus from €390 a month.',
            },
            {
              n: '04',
              t: 'Portal leads',
              ...
              price: 'from €1,200',
              rows: [
                'Idealista, Kyero and Rightmove in one place',
                'Nothing retyped by hand, nothing lost in an inbox',
                'A written sequence makes the next contact for you',
              ],
              foot: 'Plus from €190 a month.',
            },
          ],
        },
      ],
  ...
  es: {
          ...
          packs: [
            {
              ...
              price: 'desde 1.400 € / mes',
              rows: [
                'Cuatro vídeos al mes',
                'Hasta dos localizaciones',
                'Guiones y plan de publicación',
                '10% de descuento en todo lo demás',
              ],
            },
            {
              n: '02',
    ...
    funnel: {
      eyebrow: '06 — LEADS Y AUTOMATIZACIÓN',
      title: ['El vídeo los trae.', 'Esto es lo que los retiene.'],
      lede: 'El vídeo hace su trabajo, el comprador escribe por WhatsApp — y espera cuatro horas porque el agente está en una visita. Todos los estudios de esta costa se paran en el vídeo. Nosotros construimos lo que viene después: la página, el bot que responde en tres idiomas, el CRM donde cae la consulta. Las apps para una promoción se presupuestan aparte.',
      groups: [
        {
          title: 'Se construye una vez y sigue funcionando',
          packs: [
            {
              n: '01',
              t: 'Embudo del inmueble',
              count: '4 servicios',
              price: 'desde 2.900 €',
              note: 'CON RODAJE',
              rows: [
                'Página del inmueble, con dominio propio',
                'Bot de WhatsApp que responde al instante, en tres idiomas',
                'Cada consulta cae en el CRM con el origen del que viene',
                'El seguimiento sale mientras el comprador sigue caliente',
              ],
              foot: 'Más desde 190 € al mes — hosting, dominio y el bot en marcha. Con la visualización y la jornada de rodaje, el lanzamiento completo desde 6.900 €.',
            },
            {
              n: '02',
              t: 'Bot para la agencia',
              count: '4 servicios',
              price: 'desde 1.900 €',
              rows: [
                'Responde en inglés, español y ruso',
                'Pregunta qué buscan y cuánto pueden gastar',
                'Agenda la visita directamente en el calendario',
                'Entrega al agente una consulta con la que ya se ha hablado',
              ],
              foot: 'Más desde 290 € al mes.',
            },
            {
              n: '03',
              t: 'CRM inmobiliario',
              ...
              price: 'desde 4.500 €',
              rows: [
                'Hecho para cómo trabaja de verdad una agencia de aquí',
                'Inmuebles, compradores, agentes, tareas',
                'De quién es cada consulta y qué se le prometió',
                'Permisos para cada agente',
                'Los datos siguen siendo suyos, en su propio dominio',
              ],
              foot: 'Más desde 390 € al mes.',
            },
            {
              n: '04',
              t: 'Leads de portales',
              ...
              price: 'desde 1.200 €',
              rows: [
                'Idealista, Kyero y Rightmove en un solo sitio',
                'Nada que teclear a mano, nada perdido en un correo',
                'Una secuencia escrita hace el siguiente contacto por usted',
              ],
              foot: 'Más desde 190 € al mes.',
            },
          ],
        },
      ],
  ...
  ru: {
          ...
          packs: [
            {
              ...
              price: 'от 1 400 € / мес',
              rows: [
                'Четыре ролика в месяц',
                'До двух локаций',
                'Сценарии и план публикаций',
                'Минус 10% на всё остальное',
              ],
            },
            {
              n: '02',
    ...
    funnel: {
      eyebrow: '06 — ЗАЯВКИ И АВТОМАТИЗАЦИЯ',
      title: ['Ролик приводит.', 'Это — не упускает.'],
      lede: 'Ролик сработал, покупатель пишет в WhatsApp — и ждёт четыре часа, потому что агент на показе. Все студии побережья заканчивают на ролике. Мы делаем то, что идёт после него: страницу, бота, который отвечает на трёх языках, и CRM, куда падает заявка. Приложения под посёлок считаются отдельно.',
      groups: [
        {
          title: 'Собирается один раз и дальше работает',
          packs: [
            {
              n: '01',
              t: 'Воронка объекта',
              count: '4 позиции',
              price: 'от 2 900 €',
              note: 'ВМЕСТЕ СО СЪЁМКОЙ',
              rows: [
                'Страница объекта на собственном домене',
                'Бот в WhatsApp отвечает сразу, на трёх языках',
                'Каждая заявка падает в CRM вместе с источником',
                'Касание уходит, пока покупатель ещё тёплый',
              ],
              foot: 'Плюс от 190 € в месяц — хостинг, домен и работа бота. Вместе с визуализацией и съёмочной сменой весь запуск — от 6 900 €.',
            },
            {
              n: '02',
              t: 'Бот агентству',
              ...
              price: 'от 1 900 €',
              rows: [
                'Отвечает по-английски, по-испански и по-русски',
                'Спрашивает, что ищут и на что рассчитывают',
                'Записывает на просмотр сразу в календарь',
                'Отдаёт агенту заявку, с которой уже поговорили',
              ],
              foot: 'Плюс от 290 € в месяц.',
            },
            {
              n: '03',
              t: 'CRM под недвижимость',
              count: '5 позиций',
              price: 'от 4 500 €',
              rows: [
                'Сделана под то, как агентство здесь работает на самом деле',
                'Объекты, покупатели, агенты, задачи',
                'Чья заявка и что по ней обещано',
                'Права доступа по каждому агенту',
                'Данные остаются вашими и на вашем домене',
              ],
              foot: 'Плюс от 390 € в месяц.',
            },
            {
              n: '04',
              t: 'Заявки с порталов',
              ...
              price: 'от 1 200 €',
              rows: [
                'Idealista, Kyero и Rightmove в одном месте',
                'Ничего не перебивается руками и не теряется в почте',
                'Написанная цепочка сама делает следующее касание',
              ],
              foot: 'Плюс от 190 € в месяц.',
            },
          ],
        },
      ],
